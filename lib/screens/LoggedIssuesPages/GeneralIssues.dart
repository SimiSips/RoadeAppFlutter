...
class GeneralIssues extends StatefulWidget {
  const GeneralIssues({Key? key}) : super(key: key);
  static const String id = 'generalissues';
...
class _GeneralIssuesState extends State<GeneralIssues> {
  final generalReports = FirebaseDatabase.instance.reference().child("global").child("Reports").child("General");
  List<Model> list = [];
  Future<void>? _launched;

  //var image = statusImage.toString();

  //var incompleteImage = 'assets/images/incomplete.png';
  var completeImage = 'assets/images/incomplete.png';

  //get image => Image.asset('assets/images/incomplete.png', scale: 1.5,);
  ...
  _initUser() async {
    generalReports.once().then((DataSnapshot snap) {
      var data = snap.value;
      list.clear();
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    children: [
                      Image.asset(completeImage, scale: 1.5,),
                      Padding(
