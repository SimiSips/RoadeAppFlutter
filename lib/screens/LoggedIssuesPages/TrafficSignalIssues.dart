...
class TrafficSignalIssues extends StatefulWidget {
  const TrafficSignalIssues({Key? key}) : super(key: key);
  static const String id = 'trafficsignalissues';

  @override
  _TrafficSignalIssuesState createState() => _TrafficSignalIssuesState();
}

class _TrafficSignalIssuesState extends State<TrafficSignalIssues> {
  final trafficSignalReports = FirebaseDatabase.instance.reference().child("global").child("Reports").child("Traffic Signal");
  List<Model> list = [];
  ...
  _initUser() async {
    trafficSignalReports.once().then((DataSnapshot snap) {
      var data = snap.value;
      list.clear();
