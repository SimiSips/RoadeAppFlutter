...
class SignageIssues extends StatefulWidget {
  const SignageIssues({Key? key}) : super(key: key);
  static const String id = 'signageissues';

  @override
  _SignageIssuesState createState() => _SignageIssuesState();
}

class _SignageIssuesState extends State<SignageIssues> {
  final generalReports = FirebaseDatabase.instance.reference().child("global").child("Reports").child("Signage");
  List<Model> list = [];
