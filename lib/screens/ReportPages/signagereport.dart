...
class SignagePage extends StatefulWidget {
  static const String id = 'signagereport';
  const SignagePage({Key? key}) : super(key: key);
...
*/
  ...
  void submitIssueGlobal() async {
    ...
    DatabaseReference issuesGlobalRef = FirebaseDatabase.instance.reference().child('global/Reports/Signage/$fileName');
