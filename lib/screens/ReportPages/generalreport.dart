...
class GeneralPage extends StatefulWidget {
  static const String id = 'generalreport';
...
*/
  ...
  void submitIssueGlobal() async {
    ...
    DatabaseReference issuesGlobalRef = FirebaseDatabase.instance.reference().child('global/Reports/General/$fileName');
    ...
    //Take the user to the mainPage
    //Navigator.pushNamedAndRemoveUntil(context, TicketLoggedPage.id, (route) => false);
    Navigator.push(context, new MaterialPageRoute(
        builder: (context) =>
        new TicketLoggedPage())
    );
