...
class TrafficPage extends StatefulWidget {
  static const String id = 'trafficlightreport';
...
*/
  ...
  void submitIssueGlobal() async {
    ...
    DatabaseReference issuesGlobalRef = FirebaseDatabase.instance.reference().child('global/Reports/Traffic Signal/$fileName');
